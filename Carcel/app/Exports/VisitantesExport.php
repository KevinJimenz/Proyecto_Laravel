...
class VisitantesExport implements 
    FromCollection, 
    WithHeadings, 
    WithTitle, 
    WithStyles, 
    ...
    WithEvents
{
    ...
    {
        return Visitante::whereBetween('created_at', [$this->fechaInicio, $this->fechaFin])->get();
    }
    ...
    public function styles(Worksheet $sheet)
    {
        return [
            ...
            'A4:F' . (Visitante::whereBetween('created_at', [$this->fechaInicio, $this->fechaFin])->count() + 3) => [
                'borders' => [
                    'allBorders' => [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Reporte de Visitantes - Cárcel El Redentor');
