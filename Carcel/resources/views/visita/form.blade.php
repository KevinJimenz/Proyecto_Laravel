<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_hora_inicio" class="form-control @error('fecha_hora_inicio') is-invalid @enderror" value="{{ old('fecha_hora_inicio', $visita?->fecha_hora_inicio) }}" id="fecha_hora_inicio" placeholder="Fecha Hora Inicio">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_hora_fin" class="form-control @error('fecha_hora_fin') is-invalid @enderror" value="{{ old('fecha_hora_fin', $visita?->fecha_hora_fin) }}" id="fecha_hora_fin" placeholder="Fecha Hora Fin">
